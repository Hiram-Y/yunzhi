...
public class TeacherPK implements Serializable {
    ...
    public TeacherPK(String userId, int courseSchoolId, int courseId, Date courseStartDate, Date courseEndDate) {
        this.userId = userId;
    ...
    public String toString() {
        return "entity.TeacherPK[ userId=" + userId + ", courseSchoolId=" + courseSchoolId + ", courseId=" + courseId + ", courseStartDate=" + courseStartDate + ", courseEndDate=" + courseEndDate + " ]";
    }
