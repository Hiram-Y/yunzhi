...
public class QuestionPK implements Serializable {
    ...
    public QuestionPK(int sequenceNumber, int chapterCourseSchoolId, int chapterCourseId, Date chapterCourseStartDate, Date chapterCourseEndDate, int chapterSequenceNumber) {
    ...
    public String toString() {
        return "entity.QuestionPK[ sequenceNumber=" + sequenceNumber + ", chapterCourseSchoolId=" + chapterCourseSchoolId + ", chapterCourseId=" + chapterCourseId + ", chapterCourseStartDate=" + chapterCourseStartDate + ", chapterCourseEndDate=" + chapterCourseEndDate + ", chapterSequenceNumber=" + chapterSequenceNumber + " ]";
    }
