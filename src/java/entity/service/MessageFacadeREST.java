...
public class MessageFacadeREST extends AbstractFacade<Message> {
    ...
    private MessagePK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;userid=useridValue;talkTo=talkToValue;datetime=datetimeValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        entity.MessagePK key = new entity.MessagePK();
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Message entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        entity.MessagePK key = getPrimaryKey(id);
    ...
    public Message find(@PathParam("id") PathSegment id) {
        entity.MessagePK key = getPrimaryKey(id);
